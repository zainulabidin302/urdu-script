...
*  پہلا پروگرام۔اردو
 ...
 کمپایئلر کا پھلا مرحلہ لیکزیکل انیلسیز  (Lexical Anylisis) کہلاتا ہے۔ اس میں اردو کے الفاظ کہ ریگولر اکپرشنز (Regular Expressions) کی زبان میں لکھا جاتا ہے تاکہ ہم اس ایک نئی کمپیو ٹر کی زبان کو اصول کے تحت بیان کرسکیں۔
