...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','urdu.lexer.py',55),
  ('statement -> expression','statement',1,'p_statement_expr','urdu.lexer.py',59),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','urdu.lexer.py',63),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','urdu.lexer.py',64),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','urdu.lexer.py',65),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','urdu.lexer.py',66),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','urdu.lexer.py',73),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','urdu.lexer.py',77),
  ('expression -> NUMBER','expression',1,'p_expression_number','urdu.lexer.py',81),
  ('expression -> NAME','expression',1,'p_expression_name','urdu.lexer.py',85),
]
